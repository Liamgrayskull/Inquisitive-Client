...
craftingTable.addShaped("tubular_bell", <item:xercamusic:tubular_bell> * 1, [[<item:minecraft:air>, <item:create:cuckoo_clock>, <item:minecraft:air>], [<item:windchimes:iron_chime>, <item:windchimes:bamboo_chime>, <item:windchimes:copper_chime>], [<item:minecraft:air>, <item:minecraft:air>, <item:minecraft:air>]]);
