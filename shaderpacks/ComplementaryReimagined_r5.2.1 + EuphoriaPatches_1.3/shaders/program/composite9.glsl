...
void main() {
        ...
        float counter = texture2D(colortex1, ivec2(0)).a;
        counter += 0.00001;
        ...
        /* DRAWBUFFERS:71 */
        gl_FragData[0] = color;
        gl_FragData[1] = vec4(texture2D(colortex1, texCoord).rgb, ivec2(texCoord * vec2(viewWidth, viewHeight)) == ivec2(0) ? counter : texture2D(colortex1, texCoord).a);
    #endif
}
